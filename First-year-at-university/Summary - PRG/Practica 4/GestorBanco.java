...
public class GestorBanco {
            ...
            switch(op) {
                ...
                case 2: // Ingresar en la cuenta activa
                     ...
                     try {
                         ...
                         System.out.println("Información de la cuenta: " + cuenta + "\n");
                            ...
                            System.out.println("ERROR: ¡No hay ninguna cuenta activa! Primero buscala o crea una nueva cuenta");
                        }
                    break;
                ...
                case 6: // Mostrar todas las cuentas
                 ...
                 case 7:
                    ...
                    try
                    {
                        ...
                        f = new ObjectInputStream(new FileInputStream(s));
                        banco.cargarFormatoObjeto(f);
                    }
                ...
                case 8:
                    ...
                    try
                    {
                        System.out.println("Introduce el nombre del fichero: ");
                        String s = tec.nextLine();
                        p = new ObjectOutputStream(new FileOutputStream(s));
                    }
                    catch(FileNotFoundException e)
                    {
                        System.out.println("No se ha encontrado el fichero");
    ...
    private static int menu(Scanner tec) {
        ...
        System.out.println("  8) Guardar banco desde fichero");
        System.out.println("---------------------------------");        
        int opcion = LecturaValida.leerInt(tec, "    Elige una opción (0 - 8): ", 0, 8);         
        return opcion;
    }
