...
public class Entrada {
    ...
    public static final double DTO_DIA_FESTIVO = 1.2;
    
    // Descuento por ser vispera de festivo
    public static final double DTO_DIA_VISPERA_FESTIVO = 1.1;
    ...
    public Entrada(String t, String c, int hs, int ms) {
       titulo = t;
       cine = c;
       Hora horaSesion = new Hora(hs , ms);
    }
    ...
    public boolean equals(Object o) {
        return o instanceof Entrada
            ...
            && this.horaSesion == ((Entrada) o).horaSesion;
    }
    ...
    public double precioFinal(int edad, boolean diaEspec, boolean festivo, 
        ...
        if (tjtaCliente == true && diaEspec == true && festivo == true && edad >= 65){
            precioFinal=PRECIO_BASE-PRECIO_BASE*DTO_DIA_ESPECTADOR*DTO_SENIOR*DTO_DIA_FESTIVO*DTO_CLIENTE;
            return precioFinal;
        }         
        else if (diaEspec == true && visp == true && edad >= 65){
            precioFinal=PRECIO_BASE-PRECIO_BASE*DTO_DIA_ESPECTADOR*DTO_DIA_VISPERA_FESTIVO*DTO_SENIOR;
            return precioFinal;
        }

        else if (diaEspec == true && edad < 65){
        
            precioFinal=PRECIO_BASE*DTO_DIA_ESPECTADOR;
            return precioFinal;
        }
        else if (diaEspec == true && edad >= 65){
            precioFinal=PRECIO_BASE*DTO_DIA_ESPECTADOR*DTO_SENIOR;
            return precioFinal;
        }
         else if (diaEspec == true && festivo == true && edad >= 65){
            precioFinal=PRECIO_BASE-PRECIO_BASE*DTO_DIA_ESPECTADOR*DTO_SENIOR*DTO_DIA_FESTIVO;
            return precioFinal;
        }
        else if (festivo == true && edad< 65){        
            precioFinal=PRECIO_BASE*DTO_DIA_FESTIVO;
            return precioFinal;
        }
        else if (diaEspec == true && festivo == true && edad < 65){
            precioFinal=PRECIO_BASE*DTO_DIA_ESPECTADOR*DTO_DIA_FESTIVO;
            return precioFinal;
        }
        else if (festivo == true && edad>= 65){
        
            precioFinal=PRECIO_BASE-PRECIO_BASE*DTO_DIA_ESPECTADOR*DTO_SENIOR;
            return precioFinal;
        }
        else if (diaEspec == true && visp == true && edad < 65){
            precioFinal=PRECIO_BASE-(PRECIO_BASE*DTO_DIA_ESPECTADOR*DTO_DIA_VISPERA_FESTIVO);
            return precioFinal;
        }
        else if (diaEspec == true && visp == true && edad >= 65){
            precioFinal=PRECIO_BASE-PRECIO_BASE*DTO_DIA_ESPECTADOR*DTO_DIA_VISPERA_FESTIVO*DTO_SENIOR;
        ...
        else if (visp == true && edad < 65){
        
            precioFinal=PRECIO_BASE-PRECIO_BASE*DTO_DIA_VISPERA_FESTIVO;
            return precioFinal;
        }
        else if (visp = true && edad >= 65){
        
            precioFinal=PRECIO_BASE-PRECIO_BASE*DTO_DIA_VISPERA_FESTIVO*DTO_SENIOR;
            return precioFinal;
        }
        else if (tjtaCliente == true && diaEspec == true && festivo == true && edad < 65){
            precioFinal=PRECIO_BASE-PRECIO_BASE*DTO_DIA_ESPECTADOR*DTO_DIA_FESTIVO*DTO_CLIENTE;
            return precioFinal;
        }
        else if (tjtaCliente == true && diaEspec == true && festivo == true && edad >= 65){
            precioFinal=PRECIO_BASE-PRECIO_BASE*DTO_DIA_ESPECTADOR*DTO_SENIOR*DTO_DIA_FESTIVO*DTO_CLIENTE;
        ...
        else if (tjtaCliente == true && diaEspec == true && visp == true && edad < 65){
            precioFinal=PRECIO_BASE-PRECIO_BASE*DTO_DIA_ESPECTADOR*DTO_DIA_VISPERA_FESTIVO*DTO_CLIENTE;
            return precioFinal;
        }
        else if (tjtaCliente == true && diaEspec == true && visp == true && edad >= 65){
            precioFinal=PRECIO_BASE-PRECIO_BASE*DTO_DIA_ESPECTADOR*DTO_DIA_VISPERA_FESTIVO*DTO_CLIENTE*DTO_SENIOR;
            return precioFinal;
        }
        else if (tjtaCliente == true && visp==true && edad < 65) {
        
            precioFinal=(PRECIO_BASE*DTO_CLIENTE*DTO_DIA_VISPERA_FESTIVO);
            return precioFinal;
        }   
        else if (tjtaCliente == true && visp == true && edad >= 65){
        
            precioFinal=(PRECIO_BASE*DTO_CLIENTE*DTO_SENIOR*DTO_DIA_VISPERA_FESTIVO);
            return precioFinal;
        }
        else if (tjtaCliente == true && edad < 65) {
        
            precioFinal=PRECIO_BASE*DTO_CLIENTE;
            return precioFinal;
        }   
        else if (tjtaCliente == true && edad >= 65){
        
            precioFinal=PRECIO_BASE-PRECIO_BASE*DTO_CLIENTE*DTO_SENIOR;
            return precioFinal;
        }
        else if ( edad >= 65) {
           
           precioFinal=PRECIO_BASE-PRECIO_BASE*DTO_SENIOR;
           return precioFinal;
        }
        else if (edad < 65){
