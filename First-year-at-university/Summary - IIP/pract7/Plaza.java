...
public class Plaza {
    ...
    /** Devuelve la hora de entrada.
      ...
      */
    public Hora getHoraEntrada(){return horaEntrada;}
    ...
    /** Actualiza la matricula.
      ...
      */
    public void setMatricula(String nuevamat){matricula = nuevamat;}

    /** Actualiza la hora de entrada.
      * @param h Hora que indica la hora de entrada del coche.
      */
    public void setHoraEntrada(Hora horaNueva){horaEntrada = horaNueva;}
    ...
    public String toString(){
      String res = "Coche con matricula " + matricula + " en plaza " + planta + "-" + plaza + ", entrada a las " + horaEntrada ;
      if (matricula == null){return "No hay ningun coche en esta plaza";}
      return res;
    }
